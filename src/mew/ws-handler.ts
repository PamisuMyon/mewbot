...
import { Auth, ConnectOptions, ConnectStatus, Dispatch, DispatchEvent, initConnectOptions, MessageCreateData, refine } from './model/index.js';
...
export class WsHandler extends BaseEmitter<{
    ...
    protected refineDispatch(raw: Dispatch) {
        ...
        if (raw.event == DispatchEvent.MessageCreate) {
            refine(raw.data as MessageCreateData);
        }
    }
